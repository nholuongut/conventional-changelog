...
describe('conventional-changelog-jquery', () => {
  ...
  it('should generate a changelog', async () => {
    for await (let chunk of conventionalChangelogCore(
      ...
      expect(chunk).toContain(', closes [gh-100](https://github.com/nholuongut/conventional-changelog/issues/100)')
      ...
      expect(chunk).toContain(', closes [#2](https://bugs.jquery.com/ticket/2) [#4](https://bugs.jquery.com/ticket/4) [gh-200](https://github.com/nholuongut/conventional-changelog/issues/200)')
